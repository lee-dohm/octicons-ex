%{
  "file-directory" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:276"},
    "height" => 16,
    "keywords" => ["folder"],
    "name" => "file-directory",
  ...
  "squirrel" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:779"},
    "height" => 16,
    "keywords" => ["ship", "shipit", "launch"],
    "name" => "squirrel",
  ...
  "question" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:649"},
    "height" => 16,
  ...
  "bookmark" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:54"},
    "height" => 16,
    "keywords" => ["tab", "star"],
    "name" => "bookmark",
  ...
  "database" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:190"},
    "height" => 16,
    "keywords" => ["disks", "data"],
    "name" => "database",
  ...
  "no-newline" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:603"},
    "height" => 16,
    "keywords" => ["return"],
    "name" => "no-newline",
  ...
  "file-media" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:280"},
    "height" => 16,
  ...
  "comment" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:169"},
    "height" => 16,
  ...
  "github-action" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "8346:4"},
    "height" => 16,
    "keywords" => ["board", "workflow", "action", "automation"],
    "name" => "github-action",
  ...
  "cloud-download" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:152"},
    "height" => 16,
  ...
  "file-pdf" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:285"},
    "height" => 16,
    "keywords" => ["adobe"],
    "name" => "file-pdf",
  ...
  "diff-modified" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:227"},
    "height" => 16,
  ...
  "repo-pull" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:691"},
    "height" => 16,
  ...
  "file-zip" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:316"},
    "height" => 16,
  ...
  "code" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:160"},
    "height" => 16,
    "keywords" => ["brackets"],
    "name" => "code",
  ...
  "versions" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:923"},
    "height" => 16,
  ...
  "clock" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:147"},
    "height" => 16,
    "keywords" => ["time", "hour", "minute", "second", "watch"],
    "name" => "clock",
  ...
  "mortar-board" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:594"},
    "height" => 16,
  ...
  "arrow-right" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:12"},
    "height" => 16,
  ...
  "file-code" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:270"},
    "height" => 16,
    "keywords" => ["text", "javascript", "html", "css", "php", "ruby",
     "coffeescript", "sass", "scss"],
    "name" => "file-code",
  ...
  "octoface" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:609"},
    "height" => 16,
    "keywords" => ["octocat", "brand"],
    "name" => "octoface",
  ...
  "stop" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:785"},
    "height" => 16,
    "keywords" => ["block", "spam", "report"],
    "name" => "stop",
  ...
  "quote" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:655"},
    "height" => 16,
    "keywords" => ["quotation"],
    "name" => "quote",
  ...
  "arrow-small-right" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:20"},
    "height" => 16,
  ...
  "clippy" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:138"},
    "height" => 16,
    "keywords" => ["copy", "paste", "save", "capture", "clipboard"],
    "name" => "clippy",
    "path" => "<path fill-rule=\"evenodd\" d=\"M2 13h4v1H2v-1zm5-6H2v1h5V7zm2 3V8l-3 3 3 3v-2h5v-2H9zM4.5 9H2v1h2.5V9zM2 12h2.5v-1H2v1zm9 1h1v2c-.02.28-.11.52-.3.7-.19.18-.42.28-.7.3H1c-.55 0-1-.45-1-1V4c0-.55.45-1 1-1h3c0-1.11.89-2 2-2 1.11 0 2 .89 2 2h3c.55 0 1 .45 1 1v5h-1V6H1v9h10v-2zM2 5h8c0-.55-.45-1-1-1H8c-.55 0-1-.45-1-1s-.45-1-1-1-1 .45-1 1-.45 1-1 1H3c-.55 0-1 .45-1 1z\"/>",
    "width" => 14
  },
  "chevron-up" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:123"},
    "height" => 16,
  ...
  "organization" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:613"},
    "height" => 16,
  ...
  "sign-out" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:768"},
    "height" => 16,
    "keywords" => ["door", "arrow", "direction", "leave", "log out"],
    "name" => "sign-out",
  ...
  "pin" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:635"},
    "height" => 16,
    "keywords" => ["save", "star", "bookmark"],
    "name" => "pin",
  ...
  "keyboard" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:466"},
    "height" => 16,
  ...
  "terminal" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:815"},
    "height" => 16,
  ...
  "unfold" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:857"},
    "height" => 16,
  ...
  "key" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:938"},
    "height" => 16,
  ...
  "fold-down" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "10708:8"},
    "height" => 16,
    "keywords" => ["unfold", "hide", "collapse", "down"],
    "name" => "fold-down",
  ...
  "settings" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:751"},
    "height" => 16,
    "keywords" => ["sliders", "filters", "controls", "levels"],
    "name" => "settings",
  ...
  "text-size" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:821"},
    "height" => 16,
  ...
  "italic" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:454"},
    "height" => 16,
  ...
  "gist-secret" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:347"},
    "height" => 16,
  ...
  "arrow-both" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "7345:13"},
    "height" => 16,
    "keywords" => ["point", "direction", "left", "right"],
    "name" => "arrow-both",
    "path" => "<path d=\"M0 8l6-5v3h8V3l6 5-6 5v-3H6v3L0 8z\"/>",
    "width" => 20
  },
  "bug" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:78"},
    "height" => 16,
    "keywords" => ["insect", "issue"],
    "name" => "bug",
  ...
  "jersey" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:458"},
    "height" => 16,
  ...
  "eye" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:255"},
    "height" => 16,
  ...
  "desktop-download" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:196"},
    "height" => 16,
  ...
  "report" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:885"},
    "height" => 16,
  ...
  "triangle-up" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:853"},
    "height" => 16,
  ...
  "device-camera" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:202"},
    "height" => 16,
  ...
  "trashcan" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:844"},
    "height" => 16,
  ...
  "arrow-small-down" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:16"},
    "height" => 16,
    "keywords" => ["point", "direction", "little", "tiny"],
  ...
  "gift" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:338"},
    "height" => 16,
  ...
  "screen-normal" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:906"},
    "height" => 16,
  ...
  "mention" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:579"},
    "height" => 16,
    "keywords" => ["at", "ping"],
    "name" => "mention",
  ...
  "check" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:104"},
    "height" => 16,
  ...
  "logo-github" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:536"},
    "height" => 16,
    "keywords" => ["brand", "github", "logo"],
    "name" => "logo-github",
  ...
  "person" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:633"},
    "height" => 16,
  ...
  "graph" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:396"},
    "height" => 16,
  ...
  "flame" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:325"},
    "height" => 16,
  ...
  "file-symlink-directory" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:298"},
    "height" => 16,
  ...
  "dash" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:178"},
    "height" => 16,
  ...
  "repo" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:706"},
    "height" => 16,
    "keywords" => ["book", "journal", "repository"],
    "name" => "repo",
  ...
  "file-symlink-file" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:303"},
    "height" => 16,
    "keywords" => ["link", "alias"],
  ...
  "verified" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:919"},
    "height" => 16,
    "keywords" => ["trusted", "secure", "trustworthy", "signed"],
    "name" => "verified",
  ...
  "dashboard" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:182"},
    "height" => 16,
    "keywords" => ["speed", "dial"],
    "name" => "dashboard",
  ...
  "star" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:781"},
    "height" => 16,
  ...
  "diff-renamed" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:237"},
    "height" => 16,
  ...
  "issue-reopened" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:448"},
    "height" => 16,
    "keywords" => ["regression"],
    "name" => "issue-reopened",
  ...
  "zap" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:934"},
    "height" => 16,
  ...
  "triangle-right" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:851"},
    "height" => 16,
    "keywords" => ["arrow", "point", "direction"],
    "name" => "triangle-right",
  ...
  "chevron-right" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:121"},
    "height" => 16,
    "keywords" => ["triangle", "arrow"],
    "name" => "chevron-right",
  ...
  "issue-opened" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:442"},
    "height" => 16,
    "keywords" => ["new"],
    "name" => "issue-opened",
  ...
  "calendar" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:82"},
    "height" => 16,
    "keywords" => ["time", "day", "month", "year", "date", "appointment"],
    "name" => "calendar",
  ...
  "thumbsdown" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:831"},
    "height" => 16,
    "keywords" => ["thumb", "thumbsdown", "rejected", "dislike"],
    "name" => "thumbsdown",
  ...
  "circuit-board" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:132"},
    "height" => 16,
  ...
  "diff-added" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:217"},
    "height" => 16,
    "keywords" => ["new", "addition", "plus"],
    "name" => "diff-added",
  ...
  "gist" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:354"},
    "height" => 16,
  ...
  "horizontal-rule" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:412"},
    "height" => 16,
    "keywords" => ["hr"],
  ...
  "gear" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:334"},
    "height" => 16,
    "keywords" => ["settings"],
    "name" => "gear",
  ...
  "fold-up" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "10708:2"},
    "height" => 16,
    "keywords" => ["unfold", "hide", "collapse", "up"],
    "name" => "fold-up",
  ...
  "unmute" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:862"},
    "height" => 16,
  ...
  "arrow-small-up" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:22"},
    "height" => 16,
    "keywords" => ["point", "direction", "little", "tiny"],
    "name" => "arrow-small-up",
  ...
  "plug" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:637"},
    "height" => 16,
  ...
  "diff-removed" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:232"},
    "height" => 16,
  ...
  "primitive-dot" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:641"},
    "height" => 16,
    "keywords" => ["circle"],
    "name" => "primitive-dot",
  ...
  "repo-clone" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:669"},
    "height" => 16,
    "keywords" => ["book", "journal", "repository"],
    "name" => "repo-clone",
  ...
  "repo-push" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:700"},
    "height" => 16,
    "keywords" => ["book", "journal", "repository", "put"],
    "name" => "repo-push",
  ...
  "git-commit" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:366"},
    "height" => 16,
    "keywords" => ["save"],
    "name" => "git-commit",
  ...
  "chevron-down" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:117"},
    "height" => 16,
    "keywords" => ["triangle", "arrow"],
    "name" => "chevron-down",
  ...
  "git-pull-request" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:382"},
    "height" => 16,
    "keywords" => ["review"],
  ...
  "note" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:891"},
    "height" => 16,
  ...
  "archive" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "2228:2"},
    "height" => 16,
    "keywords" => ["box", "catalog"],
    "name" => "archive",
  ...
  "radio-tower" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:659"},
    "height" => 16,
    "keywords" => ["broadcast"],
    "name" => "radio-tower",
  ...
  "file" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:308"},
    "height" => 16,
  ...
  "search" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:729"},
    "height" => 16,
  ...
  "mail" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:558"},
    "height" => 16,
  ...
  "briefcase" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:58"},
    "height" => 16,
  ...
  "diff-ignored" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:222"},
    "height" => 16,
    "keywords" => ["slash"],
    "name" => "diff-ignored",
  ...
  "device-desktop" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:208"},
    "height" => 16,
  ...
  "telescope" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:806"},
    "height" => 16,
  ...
  "cloud-upload" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:156"},
    "height" => 16,
    "keywords" => ["put", "export"],
    "name" => "cloud-upload",
  ...
  "mirror" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:589"},
    "height" => 16,
    "keywords" => ["reflect"],
    "name" => "mirror",
  ...
  "circle-slash" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:127"},
    "height" => 16,
  ...
  "sign-in" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:764"},
    "height" => 16,
    "keywords" => ["door", "arrow", "direction", "enter", "log in"],
    "name" => "sign-in",
  ...
  "triangle-left" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:849"},
    "height" => 16,
    "keywords" => ["arrow", "point", "direction"],
    "name" => "triangle-left",
  ...
  "thumbsup" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:835"},
    "height" => 16,
    "keywords" => ["thumb", "thumbsup", "prop", "ship", "like"],
    "name" => "thumbsup",
  ...
  "watch" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:929"},
    "height" => 16,
    "keywords" => ["wait", "hourglass", "time", "date"],
    "name" => "watch",
  ...
  "sync" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:791"},
    "height" => 16,
  ...
  "heart" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:400"},
    "height" => 16,
    "keywords" => ["love", "beat"],
    "name" => "heart",
  ...
  "home" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:408"},
    "height" => 16,
  ...
  "arrow-left" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:10"},
    "height" => 16,
    "keywords" => ["point", "direction"],
    "name" => "arrow-left",
  ...
  "reply" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:554"},
    "height" => 16,
  ...
  "location" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:516"},
    "height" => 16,
  ...
  "list-ordered" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:500"},
    "height" => 16,
  ...
  "link-external" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:956"},
    "height" => 16,
  ...
  "tag" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:795"},
    "height" => 16,
    "keywords" => ["release"],
    "name" => "tag",
  ...
  "arrow-up" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:14"},
    "height" => 16,
    "keywords" => ["point", "direction"],
    "name" => "arrow-up",
  ...
  "book" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:43"},
    "height" => 16,
  ...
  "logo-gist" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:529"},
    "height" => 16,
    "keywords" => ["brand", "github", "logo"],
    "name" => "logo-gist",
  ...
  "repo-force-push" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:681"},
    "height" => 16,
  ...
  "kebab-vertical" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:880"},
    "height" => 16,
  ...
  "paintcan" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:624"},
    "height" => 16,
  ...
  "git-merge" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:376"},
    "height" => 16,
    "keywords" => ["join"],
    "name" => "git-merge",
  ...
  "rocket" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:715"},
    "height" => 16,
    "keywords" => ["staff", "stafftools", "blast", "off", "space", "launch",
     "ship"],
    "name" => "rocket",
  ...
  "globe" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:389"},
    "height" => 16,
    "keywords" => ["world", "earth", "planet"],
    "name" => "globe",
  ...
  "broadcast" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:63"},
    "height" => 16,
  ...
  "project" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:868"},
    "height" => 16,
  ...
  "file-submodule" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:292"},
    "height" => 16,
    "keywords" => ["folder"],
    "name" => "file-submodule",
  ...
  "pulse" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:645"},
    "height" => 16,
    "keywords" => ["graph", "trend", "line", "activity"],
    "name" => "pulse",
    "path" => "<path fill-rule=\"evenodd\" d=\"M11.5 8L8.8 5.4 6.6 8.5 5.5 1.6 2.38 8H0v2h3.6l.9-1.8.9 5.4L9 8.5l1.6 1.5H14V8h-2.5z\"/>",
    "width" => 14
  },
  "server" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:733"},
    "height" => 16,
  ...
  "request-changes" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "12138:2"},
    "height" => 15,
    "keywords" => ["diff", "changes", "request"],
  ...
  "law" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:490"},
    "height" => 16,
    "keywords" => ["legal", "bill"],
    "name" => "law",
  ...
  "plus-small" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:947"},
    "height" => 16,
  ...
  "package" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:617"},
    "height" => 16,
    "keywords" => ["box", "ship"],
    "name" => "package",
  ...
  "mail-read" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:547"},
    "height" => 16,
    "keywords" => ["email", "open"],
    "name" => "mail-read",
  ...
  "git-compare" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:370"},
    "height" => 16,
  ...
  "fold" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:329"},
    "height" => 16,
  ...
  "tasklist" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:800"},
    "height" => 16,
    "keywords" => ["todo"],
    "name" => "tasklist",
  ...
  "pencil" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:630"},
    "height" => 16,
  ...
  "ruby" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:724"},
    "height" => 16,
    "keywords" => ["code", "language"],
    "name" => "ruby",
    "path" => "<path fill-rule=\"evenodd\" d=\"M13 6l-5 5V4h3l2 2zm3 0l-8 8-8-8 4-4h8l4 4zm-8 6.5L14.5 6l-3-3h-7l-3 3L8 12.5z\"/>",
    "width" => 16
  },
  "three-bars" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:826"},
    "height" => 16,
    "keywords" => ["hamburger", "menu", "dropdown"],
    "name" => "three-bars",
  ...
  "screen-full" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:898"},
    "height" => 16,
  ...
  "browser" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:70"},
    "height" => 16,
    "keywords" => ["window", "web"],
    "name" => "browser",
  ...
  "diff" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:242"},
    "height" => 16,
  ...
  "issue-closed" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:436"},
    "height" => 16,
  ...
  "eye-closed" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "10292:11"},
    "height" => 13.921463966369629,
    "keywords" => ["hidden", "invisible", "concealed", ""],
    "name" => "eye-closed",
  ...
  "comment-discussion" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:164"},
    "height" => 16,
  ...
  "bell" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:34"},
    "height" => 16,
  ...
  "hubot" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:419"},
    "height" => 16,
    "keywords" => ["robot", "bot"],
    "name" => "hubot",
  ...
  "smiley" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:772"},
    "height" => 16,
  ...
  "mark-github" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:563"},
    "height" => 16,
    "keywords" => ["octocat", "brand", "github", "logo"],
    "name" => "mark-github",
  ...
  "mute" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:599"},
    "height" => 16,
  ...
  "device-camera-video" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:198"},
    "height" => 16,
  ...
  "info" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:430"},
    "height" => 16,
    "keywords" => ["help"],
    "name" => "info",
  ...
  "lock" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:521"},
    "height" => 16,
  ...
  "ellipsis" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:249"},
    "height" => 16,
  ...
  "arrow-small-left" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:18"},
    "height" => 16,
    "keywords" => ["point", "direction", "little", "tiny"],
  ...
  "milestone" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:583"},
    "height" => 16,
    "keywords" => ["marker"],
    "name" => "milestone",
  ...
  "list-unordered" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:508"},
    "height" => 16,
  ...
  "plus" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:639"},
    "height" => 16,
  ...
  "device-mobile" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:212"},
    "height" => 16,
  ...
  "primitive-square" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:643"},
    "height" => 16,
    "keywords" => ["box"],
  ...
  "tools" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:839"},
    "height" => 16,
  ...
  "unverified" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:914"},
    "height" => 16,
    "keywords" => ["insecure", "untrusted", "signed"],
    "name" => "unverified",
  ...
  "chevron-left" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:119"},
    "height" => 16,
    "keywords" => ["triangle", "arrow"],
    "name" => "chevron-left",
  ...
  "alert" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:5"},
    "height" => 16,
  ...
  "link" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:496"},
    "height" => 16,
  ...
  "megaphone" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:572"},
    "height" => 16,
  ...
  "markdown" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:567"},
    "height" => 16,
  ...
  "repo-forked" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:685"},
    "height" => 16,
  ...
  "kebab-horizontal" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:875"},
    "height" => 16,
    "keywords" => ["kebab", "dot", "menu", "more"],
  ...
  "light-bulb" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:951"},
    "height" => 16,
    "keywords" => ["idea"],
    "name" => "light-bulb",
  ...
  "triangle-down" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:847"},
    "height" => 16,
    "keywords" => ["arrow", "point", "direction"],
    "name" => "triangle-down",
  ...
  "grabber" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:942"},
    "height" => 16,
    "keywords" => ["mover", "drap", "drop", "sort"],
    "name" => "grabber",
    "path" => "<path fill-rule=\"evenodd\" d=\"M8 4v1H0V4h8zM0 8h8V7H0v1zm0 3h8v-1H0v1z\"/>",
    "width" => 8
  },
  "history" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:404"},
    "height" => 16,
  ...
  "git-branch" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:360"},
    "height" => 16,
    "keywords" => ["fork", "branch", "git", "duplicate"],
    "name" => "git-branch",
  ...
  "rss" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:719"},
    "height" => 16,
    "keywords" => ["broadcast", "feed", "atom"],
    "name" => "rss",
  ...
  "inbox" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:426"},
    "height" => 16,
  ...
  "play" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "8346:0"},
    "height" => 16,
    "keywords" => ["play", "start", "begin", "action"],
    "name" => "play",
  ...
  "file-binary" => %{
    "figma" => %{"file" => "FP7lqd1V00LUaT5zvdklkkZr", "id" => "0:260"},
    "height" => 16,
